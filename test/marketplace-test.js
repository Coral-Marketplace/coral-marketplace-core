...
describe('************ Marketplace ******************', ()  => {
  ...
  it('Should put new NFT for sale', async () => {
    ...
    const tx1 = await nft.connect(seller).createToken('https://fake-uri-1.com', artistAddress, royaltyValue, false);
    const receipt1 = await tx1.wait();
    token1Id = receipt1.events[0].args[2].toNumber();

    const tx2 = await nft.connect(seller).createToken('https://fake-uri-2.com', artistAddress, royaltyValue, false);
